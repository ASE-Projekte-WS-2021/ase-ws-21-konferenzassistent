...
import com.ase.konferenzassistent.databinding.MeetingBottomSheetBinding;
...
public class MeetingBottomSheetAdapter extends BottomSheetDialogFragment {
    ...
    private int getActionBarSize() {
        final TypedArray array = requireContext().getTheme().obtainStyledAttributes(new int[]{android.R.attr.actionBarSize});
