...
import com.ase.konferenzassistent.mainscreen.participants.ContactCreationBottomSheetAdapter;
import com.ase.konferenzassistent.mainscreen.participants.DialogUserInfoViewCreator;
...
public class RecyclerViewParticipantListAdapter extends RecyclerView.Adapter<RecyclerViewParticipantListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (openedFromWizard) {
            ...
            holder.participantContainer.setOnClickListener(containerView -> {
                View alertDialogView = DialogUserInfoViewCreator.createView(mContext, asParticipantData, true);
